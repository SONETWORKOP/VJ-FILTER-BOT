...
LOG_CHANNEL = int(environ.get('LOG_CHANNEL', '-1002217956448'))
ADMINS = [int(admin) if id_pattern.search(admin) else admin for admin in environ.get('ADMINS', '6245798111').split()]
CHANNELS = [int(ch) if id_pattern.search(ch) else ch for ch in environ.get('CHANNELS', '-1002217956448').split()]
...
SUPPORT_CHAT = environ.get('SUPPORT_CHAT', 'CN_DISCUSSION') # Support Chat Link Without https:// or @
